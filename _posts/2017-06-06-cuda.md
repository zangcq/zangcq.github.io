...
tags: ["CUDA", "GPU"]
permalink: "/2017/06/06/cuda-%e5%8f%8d%e7%bc%96%e8%af%91%e5%b7%a5%e5%85%b7/"
legacy: true
toc: true
classes: wide
---
...
**其他常用选项** 见 [nvidia-CUDA Binary Utilities-2.2. Command-line Options ](<https://docs.nvidia.com/cuda/cuda-binary-utilities/index.html#cuobjdump-options>)
...
更多详见[nvidia-CUDA Binary Utilities-3.2. Command-line Options](<https://docs.nvidia.com/cuda/cuda-binary-utilities/index.html#nvdisasm-options>) 获取 kernel 的控制流图 To get the control flow graph of a kernel, use the following:
```
