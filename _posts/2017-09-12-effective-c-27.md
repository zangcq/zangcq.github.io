...
categories: ["C/C++"]
tags: ["C/C++"]
permalink: "/2017/09/12/effective-c-%e6%9d%a1%e6%ac%be27-%e4%b9%8b-%e7%b1%bb%e5%9e%8b%e8%bd%ac%e6%8d%a2/"
legacy: true
toc: true
classes: wide
---
...
注意，在隐式转换的相反过程中，dynamic_cast 会检查操作是否有效，他会检查转换是否会返回一个被请求的完整对象，如果不是一个有效的对象指针，返回值是`NULL`.
...
static_cast 允许执行任意的隐式转换 和 相反转换 动作。
...
>   1. C++的四种cast操作符的区别--类型转换<https://www.cnblogs.com/welfare/articles/336091.html>
>
