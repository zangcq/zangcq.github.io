...
permalink: "/2019/05/12/git-%e5%b7%a5%e4%bd%9c%e6%b5%81%e7%a8%8b/"
legacy: true
toc: true
classes: wide
---
...
```
    ...
    git clone git@code.byted.org:sys/openjdk.git
    cd openjdk
    touch README.md
    git add README.md
    ...
    cd existing_folder
    git init
    git remote add origin git@code.byted.org:sys/openjdk.git
    git add .
