...
categories: ["C/C++"]
permalink: "/2019/05/14/c-const%e7%90%86%e8%a7%a3/"
legacy: true
toc: true
classes: wide
---
...
```
    ...
    class stack { 
      ...
      int stack::GetCount(void) const { m_num++; } 
```
...
> <https://stackoverflow.com/questions/33261204/invalid-conversion-from-const-type-to-type>
