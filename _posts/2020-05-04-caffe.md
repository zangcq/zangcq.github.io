...
categories: ["机器学习"]
permalink: "/2020/05/04/caffe%e7%8e%af%e5%a2%83%e7%9a%84%e4%b8%80%e4%ba%9b%e5%9d%91%e5%90%88%e9%9b%86/"
legacy: true
toc: true
classes: wide
---
...
```
  ...
  * 手动安装opencv
<https://blog.csdn.net/antony1776/article/details/73528028>
...
```
    ...
    git clone git@gitlab.alibaba-inc.com:EdgeDet/caffe_faster_rcnn_quantize.git
    ...
    # run demo
    $python quantize_pose/demo_inference.py ../faster_hema_poseattv6_630_bias_split_no_inplace_quant_merge_3.prototxt ../faster_hema_poseatt_v6_630_bias_split_no_inplace_quant_merge_3.caffemodel --images_path_list poselist.txt --images_root_folder ./posetest/
...
```
    ...
    配置一下 caffe 的makefile.config
    BLAS := open
    BLAS_INCLUDE :=  /path/to/your/installation/include
    BLAS_LIB := /path/to/your/installation/lib
```
...
```
    ...
    # download url
    https://sourceforge.net/projects/boost/files/boost/1.57.0/boost_1_57_0.tar.bz2/download
...
> <http://gitlab.alibaba-inc.com/EdgeDet/caffe_faster_rcnn_quantize>
...
![image.png](https://intranetproxy.alipay.com/skylark/lark/0/2019/png/131289/1557836806744-49f8514b-a315-4987-93a6-e94d6a3648fb.png)
